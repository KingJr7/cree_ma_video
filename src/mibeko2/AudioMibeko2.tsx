// Mibeko2 — voix off (voiceca.mp3) + nappe légère + sound design (pops/whoosh sync aux coupes)
...
export const AudioMibeko2: React.FC = () => {
  ...
  return (
    <>
      ...
      <Audio src={staticFile("voiceca.mp3")} volume={0.95} />
      {drops}
    </>
  );
};
