...
// Mockup téléphone flat (sans isométrie : un seul plan pour la lisibilité).
// Bord noir mat, encoche statique, pas de barre de navigateur — juste une
// status bar minimaliste pour donner l'illusion d'une app native.
...
}> = ({ width, height, children, bg = theme.colors.bgAlt, showStatusBar = true }) => (
  <div
    style={{
      width,
      height,
