// Transcrit audio_voix.wav via AssemblyAI -> public/vo.json (mots + timestamps ms)
...
const audio = readFileSync("audio_voix.wav");
...
writeFileSync(
  ...
  JSON.stringify(
    {
      text: tr.text,
      words: tr.words.map((w) => ({ t: w.text, s: w.start, e: w.end })),
